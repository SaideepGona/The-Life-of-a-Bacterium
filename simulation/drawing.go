...
func (p *Petri) DrawPetri() Canvas {
	...
	// Use this function instead of the function below to see the energy dynamics
	// This function first colors bacteria according to strain value
	// Then, when one strain of bacteria dominates, the color scheme switches to energy dependent.
	/*
...
/*this function draws the drug package*/
...
/*this function draws the predator killer*/

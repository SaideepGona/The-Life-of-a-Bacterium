// Code by Kwanho Kim, Xinling Li, Zhenyu Yang
...
// Picks a random inintial location to initate predator
...
// Checks whether there is an overlap with another bacteria
